...
import top.javahai.chatroom.converter.MyContentConverter;
import top.javahai.chatroom.data.GroupMsgContentData;
...
public class GroupMsgContent implements Serializable {
   ...
   * @return
   */
  public static GroupMsgContentData convertEntityToData(GroupMsgContent groupMsgContent)
