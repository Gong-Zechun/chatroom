...
前端工程源码地址：https://github.com/JustCoding-Hai/chatroom-vue

后端工程源码地址：https://github.com/JustCoding-Hai/chatroom

简化版的后端项目地址(不使用RabbitMQ和Redis): https://github.com/JustCoding-Hai/chatroom-mini
...
## 部署流程
1. clone 项目到本地
2. 在本地 MySQL 中创建一个空的数据库 chatroom，在该数据库中运行提供的数据库脚本chatroom.sql,完成表的创建和数据的导入。
...
7. 在 IntelliJ IDEA 中打开chatroom项目，先启动 mail模块，再启动web模块。

8. 启动vue项目。

## 文档
请点击这个查看wiki的文档.
[项目文档](https://github.com/JustCoding-Hai/chatroom/wiki)
